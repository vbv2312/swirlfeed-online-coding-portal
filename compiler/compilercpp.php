...
shell_exec("chmod 777 errorcpp.txt");
shell_exec('g++ -lm hello.cpp 2> errorcpp.txt');
$error="errorcpp.txt";
$file="";
$file=file_get_contents("$error");
if($file!="")
{
$error=str_replace("hello.cpp","in yr code at position",$file);
echo "<pre>$error</pre>";
}
else
{
